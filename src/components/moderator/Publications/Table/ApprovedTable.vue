<template>
  <div class="publications-approved-table main-content">
    <div class="publications-approved-table__top main-table_white">
      <div class="publications-approved-table__row">
        <div class="publications-approved-table__parameter main-table__column">
          <p>Id</p>
        </div>
        <div class="publications-approved-table__parameter main-table__column">
          <p>Заголовок</p>
        ...
        <div class="publications-approved-table__parameter main-table__column">
          <p>Тип</p>
          <FilterArrowsIcon class="publications-approved-table__icon" />
        </div>
        <div class="publications-approved-table__parameter main-table__column">
          <p>Модератор</p>
        </div>
    ...
    <div class="publications-approved-table__body">
      <router-link
      ...
      >
        ...
        <div class="publications-approved-table__value main-table__column">
          <p class="publications-approved-table__date">
