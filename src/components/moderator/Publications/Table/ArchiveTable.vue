<template>
  <div class="publications-archive-table main-content">
    <div class="publications-archive-table__top main-table_white">
      <div class="publications-archive-table__row">
    ...
    <div class="publications-archive-table__body">
      <router-link
      ...
      >
        ...
        <div
          class="publications-archive-table__value main-table__title main-table__column"
        >
          <p>{{ item.title }}</p>
        </div>
        <div
          class="publications-archive-table__value main-table__column main-table__column_start"
        >
        ...
        <div class="publications-archive-table__value main-table__column">
          <p
            ...
            class="publications-archive-table__status main-table__status_green"
          >
            Одобрено
          </p>
          <p
            v-else-if="item.status == 'rejected'"
            class="publications-archive-table__status main-table__status_red"
          >
            Не одобрено
          </p>
          <p
            v-else-if="item.status == 'undefined'"
            class="publications-archive-table__status main-table__status_purple"
          >
            Новый
          </p>
        </div>
        ...
        <div class="publications-archive-table__value main-table__column">
          <div class="publications-archive-table__moderator">
