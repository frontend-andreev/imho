  ...
  <div class="publications-editorial-table main-content">
    ...
    <div class="publications-editorial-table__body">
      ...
      >
        ...
        <div
          class="publications-editorial-table__value main-table__title main-table__column"
        >
          <p>{{ item.title }}</p>
        </div>
        <div class="publications-editorial-table__value main-table__column">
        ...
        <div
          class="publications-editorial-table__value main-table__column main-table__column_start"
        >
